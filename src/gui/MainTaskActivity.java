...
import model.Task;
 ...
 /*
public class MainTaskActivity extends JFrame implements Observer {
  ...
  /*
    ...
    //    if (!isAlarmEvent)
     //   {
         ...
         //   controller.addTask(textField1.getText(), textField2.getText(), LocalDateTime.parse(formattedTextField1.getText()));
      //  }
   /*     else
        {
